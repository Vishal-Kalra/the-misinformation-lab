...
// Two fictional towns (Riverton, Eastvale) for variety; there's no round
// distinction anymore — see SEED_POSTS below, which is what Phase 1 actually
// draws from.
export const R1 = [
  {
...
// The fixed baseline of Phase 1's shared post pool. There's a single Phase 1
// round now (no Round 1 / Round 2 split) — every session draws a random 5
// from this set combined with whatever other learners have published in
// Phase 2 (see store.js's startPhase1() and services/communityPool.js).
export const SEED_POSTS = [...R1, ...R2];
